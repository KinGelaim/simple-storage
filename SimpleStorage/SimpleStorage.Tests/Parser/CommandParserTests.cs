...
public sealed class CommandParserTests
{
    ...
    [Fact]
    public void Success_WhenCommandWithThreeArguments_AndWithExtraSpaces()
    {
        // Arrange
        var command = " SET     user:1           data";
    ...
    [Fact]
    public void Success_WhenCommandWithTwoArguments_AndWithExtraSpaces()
    {
        // Arrange
        var command = " GET    user:1    ";
    ...
    [Fact]
    public void ReturnsDefault_WhenCommandWithOneArgument_AndWithExtraSpaces()
    {
        // Arrange
        var command = " DELETE    ";
    ...
    [Fact]
    public void ReturnsDefault_WhenCommandWithOnlySpaces()
    {
        // Arrange
        var command = "    ";
